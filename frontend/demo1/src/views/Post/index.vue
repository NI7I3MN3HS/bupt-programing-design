...
const favoriteTitle = ref(null);
const favoriteDescribe = ref(null);

const is_active_expand = ref(false);
const is_likebutton_active = ref(false);
const is_dislikebutton_active = ref(false);
...
function favoritebuttonclick(item) {
  item.is_favoritebutton_active = !item.is_favoritebutton_active;
}
function ShowCreateFavoriteInfo() {
...
function CreateNewFavorite(titlename) {
  this.items.push({
