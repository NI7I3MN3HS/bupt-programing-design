  ...
  <div>
    <n-card>
      <n-space align="center" justify="space-between">
        ...
        <n-button v-if="is_followed" @click="DeleteFollow">取消关注</n-button>
        <n-button v-if="!is_followed" @click="CreateFollow">关注</n-button>
      </n-space>
    </n-card>
  </div>
</template>
...
const is_followed = computed(() => {
  return data.value.follower_id == userStore.id ? true : false;
});
...
function CreateFollow() {
  ...
  data.value.follower_id = userStore.id;
}
//取消关注
